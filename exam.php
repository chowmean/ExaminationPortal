...
<center><font size="7" color="white">Round one (APTITUDE)
...
<form id="myform" onsubmit="return disp_confirm()" action="save_answer.php"  method="POST" style="position:absolute;top:65%;left:43%;" ><input  type="text" name="answer"  placeholder="Your choice here"/><input  type="submit" name="save" value="save" class='button' style='height:25px;'/></form>
...
<br><br>
<br><br>
<a href="prev.php"><input type="button" name="previous" value="previous" class='button'></a>
<a href="next.php"><input type="button" name="next" value="next" class='button'></a><br><br>
