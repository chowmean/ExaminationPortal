...
while($row1=$result1->fetch())
	...
	{	$sql1="select username,password from users where username='".$username."'";
		$result1 = $pdo_infotsav->query($sql1);
		while($row1=$result1->fetch())
		{$sql2='insert into users values("'.$row1[0].'","'.$password.'");';
...
echo 'user allready exist <br><br> <a href="register.php"><u>go back to registration<u>  </a>  <br><br> <a href="home.php"><u>HOME<u></a>';
